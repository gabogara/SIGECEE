...
import defaultImg from '../../../assets/images/default_large.png'
        ...
        <AppBar sx={{ position: 'relative', backgroundColor: '#0d47a1' }}>
          <Toolbar>
            <Typography sx={{ flex: 1 }} variant="h6" component="div">
              Publicar estudio de {data.title} en página principal
            </Typography>
            <IconButton
              edge="end"
              color="inherit"
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <div className='listItem-wrap'>
                      <img src={preview !== undefined ? preview : defaultImg} alt='' />
                      <header>
                        <p>
