...
import CensusTable from './tables/CensusTable';
import ViewModal from './modals/ViewCensus';
import AddModal from './modals/AddCensus';
import EditModal from './modals/EditCensus';
import DeleteModal from './modals/DeleteCensus';
import PublishModal from './modals/PublishCensus';
...
import ResultModal from './modals/ResultCensus';
...
import Img from '../../assets/images/InfoCensos.png'
...
function CensoManagement() {
  ...
  if (!creator) {
    //localization.currentLocale = 'custom';
    const deuLocale = localization.getLocale("es");
    deuLocale.ed.designer = 'Diseñador de censo'
    deuLocale.ed.testSurvey = 'Previsualizar censo'
    deuLocale.ed.logic = 'Lógica del censo'
    ...
    deuLocale.ed.surveyTypeName = "Censo"
    deuLocale.pe.surveyTitlePlaceholder = "Título del censo (Requerido)"
    deuLocale.pe.surveyDescriptionPlaceholder = "Ingrese una descripción para el censo (Requerido)"
    deuLocale.pe.pageTitlePlaceholder = "Título de la página"
    deuLocale.ed.surveySettingsTooltip = "Abrir opciones de censo"
    ...
    deuLocale.ed.lg.uncompletedRule_title = "¿Salir de la lógica de censo?"
    ...
    creator.onActiveTabChanged.add((sender, options) => {
      if (options.tabName === "test") {
        ...
        deuLocale.ed.testSurveyAgain = "Prueba de nuevo"
        deuLocale.ed.surveyTypeName = "Censo"
        deuLocale.pe.surveyTitlePlaceholder = "Título del censo"
        deuLocale.pe.surveyDescriptionPlaceholder = "Ingrese una descripción para el censo"
        deuLocale.pe.pageTitlePlaceholder = "Título de la página"
        deuLocale.ed.surveySettingsTooltip = "Abrir opciones de censo"
        deuLocale.pe.requiredText = "Símbolo para pregunta requerida"
        deuLocale.p.pages = "Páginas"
  ...
  return (
    <>
      ...
      <DeleteModal //5
        ...
        creator={creator}
      />
      <HelpModal img={Img} setVisible={setVisibleHelp} visible={visibleHelp} title="Cómo utilizar el Módulo de Censos" />
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            <CustomTab
              icon={<TableRowsIcon />}
              iconPosition="start"
              label="Todos los Censos"
              {...a11yProps(0)}
            />
            <CustomTab icon={<AddIcon />} iconPosition="start" label="Nuevo censo" {...a11yProps(1)} />
            <CustomTab
...
export default CensoManagement;
