...
var customLocaleStrings = {
  ...
  pe: {
    ...
    fastEntryPlaceholder:
      "You can set data in the following format:\nvalue1|text\nvalue2",
    ...
    responsiveImageSizeHelp:
      "Does not apply if you specify the exact image width or height.",
    ...
    separateSpecialChoices:
      "Separate special choices (None, Other, Select All)",
  ...
  pehelp: {
    ...
    totalText:
      "Visible only when at least one column has Total type or Total expression.",
    acceptedTypes:
    ...
    autocomplete:
      "Refer to the [autocomplete](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete) attribute description for more information.",
    valueName:
      "If you do not set this property, the answer will be stored in a field specified by the Name property.",
    choicesbyurl: {
      valueName: " ",
    },
    keyName:
      'If the specified column contains identical values, the survey throws the "Non-unique key value" error.',
  },
  // Properties
  p: {
    title: {
